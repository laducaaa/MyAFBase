# Chapter 5 Knowledge Checks — Military Organization and Command
...
**Rationale:** The Secretary of Defense is the President's principal defense policy advisor, formulates and executes approved defense policy, and exercises the operational chain between the President and combatant commanders.
...
**Rationale:** AFH 1 assigns the Navy sea operations, control of vital sea areas and lanes, naval reconnaissance, antisubmarine warfare, and protection of shipping.
...
**Rationale:** Marine Corps functions include seizure or defense of advanced naval bases, limited related land operations, and development of landing-force tactics, techniques, and equipment for amphibious operations.
...
**Rationale:** AFH 1 assigns the Space Force responsibility to develop concepts and forces for freedom of operation, sustained operations, protection of interests, deterrence, and operations in, from, and to space.
...
**Rationale:** CAP becomes the Air Force's volunteer civilian auxiliary when a federal department or agency uses its services. Its primary programs are emergency services and civil support, aerospace education, and cadet programs.
...
**Rationale:** A Lead MAJCOM consolidates responsibility for a particular function across the Air Force. A Component MAJCOM serves as the Air Force component to a unified combatant command and presents forces through component numbered air forces.
...
**Rationale:** AFH 1 identifies Air Combat Command as the primary provider of air combat forces and Air Mobility Command as the provider of global air mobility, including airlift, refueling, and aeromedical support.
...
**Rationale:** PACAF is the Air Force component to USINDOPACOM. USAFE and AFAFRICA operate through a blended staff but support USEUCOM and USAFRICOM through separate command roles and authorities.
...
- IDs run sequentially and uniquely from C05-Q-001 through C05-Q-060.
- Every item contains the required ADTC level, ranks, difficulty, four options, one keyed answer, rationale, three distractor explanations, paragraph citation, and review flag.
- Section allocations and answer positions are audited below.
- Items emphasize explanation, comparison, classification, inference, and organizational relationships at level B.
- No item tests an exact personnel count, headquarters location, activation date, or review interval.

## Knowledge-check coverage

| Section | Item range | AFH 1 coverage | Items | Primary emphasis |
|---|---|---|---:|---|
