# Chapter 2 Supplemental Situational Judgment Practice
...
>
> The official Air Force uses subject-matter experts and behavioral scientists to establish operational SJT scoring keys. These supplemental judgments are not official keys or substitutes for current supervisory, safety, technical, legal, ethics, public-affairs, reporting, or command procedures. Any process or authority facts needed to rank an option are supplied within the scenario as invented instructional constraints.

## How to use this set

Each scenario produces two selections:

1. Select the **most effective** response.
2. Select the **least effective** response.

Read every option before choosing. Judge the learner's present-day conduct, not the wisdom of a historical actor. Consider whether the response:

- represents sources, performance, and uncertainty honestly;
- accepts responsibility within the authority stated in the scenario;
- protects mission requirements without treating caution or speed as automatic answers;
- recognizes contributors with accuracy, dignity, and impartiality;
- supports disciplined innovation, stewardship, and readiness; and
- strengthens teamwork across specialties, services, and partner audiences.

Ten scenarios produce 20 response selections, mirroring only the historical public structure announced for the [22E5/22E6 cycles in December 2021](https://www.afpc.af.mil/News/Article-Display/Article/2874484/waps-adjusts-for-22e6-22e5-testing-cycles/). The separate [public SJT informational guide](https://www.studyguides.af.mil/Portals/15/documents/Notices/Situational-Judgment-Test-Informational-Guide.pdf) explains the four-option most/least format. Neither source confirms the 2027 structure, and the historical 22E5/22E6 format does not show that Chapter 2 history was or will be tested through scenarios.
...
**Ranks:** SSgt; TSgt  
**Review flag:** Human review of historical-editor realism; revalidate the designated source baseline before release

---

## C02-SJT-002 — A memorable but unsupported conclusion

You are the reviewer for a public heritage briefing on World War II airpower. A draft conclusion says aircraft production "single-handedly won the war." The cited Chapter 2 passages instead describe airpower as a force multiplier, air superiority as a prerequisite, and several production, training, tactical, and support factors. You may replace one conclusion slide before the approved briefing is delivered; the speaker must otherwise use the existing, source-cleared material.
...
C knowingly preserves a causal claim broader than the approved source supports. Audience engagement is useful, but it does not justify presenting simplification as fact. Chapter 1 honesty and accountable representation—not the historical outcome itself—provide the behavioral basis for the least-effective judgment.

### Option analysis

- **A — Most effective:** It gives the audience a concise conclusion that remains within the source-supported historical relationship.
- **B — Partially effective:** Oral qualification adds nuance, but the displayed claim continues to communicate an unsupported conclusion.
- **C — Least effective:** It knowingly trades historical accuracy for rhetorical force despite available revision authority.
- **D — Ineffective:** It avoids the false claim but abandons a supported conclusion that the reviewer can communicate accurately.

**Source basis:** AFH 1, ¶¶2.13–2.14 (historical context); ¶¶1.3.1, 1.3.3 (behavioral basis)  
**Primary concepts:** Accurate historical briefing; honesty; accountability; disciplined communication  
**ADTC context:** 2C, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human review of public-briefing realism; approved source and public-affairs processes control real releases

---

## C02-SJT-003 — Restoring documented credit

You edit a unit exhibit on the development of instrument flight. Its draft headline credits a famous commander with every breakthrough. The approved source packet specifically documents Sergeant William C. Ocker's flight integrator, enclosed-cockpit demonstration, and training-device contributions, while identifying later advances as broader efforts. You may revise the headline and caption; a separate contributor panel has space for supporting names.
...
A leaves the known principal misattribution in the headline, where it continues to frame the exhibit, while moving Ocker's documented work to secondary material. Chapter 2 establishes the source discrepancy, but Chapter 1 honest reporting, respect, and accountable recognition provide the behavioral basis for the least-effective judgment.

### Option analysis

- **A — Least effective:** It makes Ocker visible but knowingly preserves the misleading principal attribution in the headline.
- **B — Partially effective:** It centers Ocker and acknowledges later teamwork, but "principal pioneer" extends beyond the documented contribution.
- **C — Ineffective:** It avoids false individual credit but withholds a documented human contribution central to the exhibit.
- **D — Most effective:** It gives precise credit for supported work while preserving the interdependent nature of later progress.

**Source basis:** AFH 1, ¶2.3 (historical context); ¶¶1.1, 1.3.1–1.3.3 (behavioral basis)  
**Primary concepts:** Crediting underrecognized contributors; honesty; respect; teamwork  
**ADTC context:** 2A, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human historical-attribution review; use source-supported language rather than inferred sole credit

---

## C02-SJT-004 — Designing the readiness lesson

You lead a classroom readiness exercise built around early aviation's field-maintenance challenges. The stated objective is to show how repair capacity and backup assets affect sustained availability. After the first run, teams maximized initial launches but never had to account for aircraft entering repair. You are authorized to choose one design change for the next run; every option fits the available class time and budget.
...
D removes the accumulated resource consequences the stated objective requires learners to experience. The historical expedition is context, not a verdict on this design choice. Chapter 1 mission focus and accountable stewardship provide the behavioral basis for finding D least effective.

### Option analysis

- **A — Partially effective:** It makes backup quantity consequential but still leaves repair capacity outside learner decisions.
- **B — Most effective:** It introduces the missing relationship through one decision whose later effects learners can observe.
- **C — Ineffective:** It increases difficulty, but maintenance remains commentary rather than part of the exercise's choices.
- **D — Least effective:** It creates equal rounds by erasing the sustained-availability consequences the revision should make meaningful.

**Source basis:** AFH 1, ¶2.5 (historical context); ¶¶1.3.1, 1.3.3 (behavioral basis)  
**Primary concepts:** Maintenance/readiness lessons; mission stewardship; discipline; continuous improvement  
**ADTC context:** 2A, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human instructional-design review; this classroom model does not represent current readiness procedures
...
A describes incomplete evidence as sufficient and seeks to remove the stated testing condition because of schedule pressure. The chair would retain final authority, but the recommendation itself is not candid about the unresolved result. Chapter 1 honesty, accountability, and disciplined innovation provide the behavioral basis for the least-effective judgment.
...
A retains a familiarity-based draft assembled before the panel applied its criteria; a general introduction does not correct the selection method or make other roles visible in the profiles. Chapter 1 impartiality, accountability, respect, and mission focus provide the behavioral basis for the least-effective judgment.
...
**Source basis:** AFH 1, ¶¶2.14–2.15 (historical context); ¶¶1.1, 1.3.1–1.3.3 (behavioral basis)  
**Primary concepts:** Inclusive recognition; impartiality; respect; mission; teamwork  
**ADTC context:** 2C, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human review of selection realism and contributor breadth; no representational quota is implied

---

## C02-SJT-007 — Completed is not yet verified

A heritage seminar on wartime production and maintenance prompts your section's unclassified training-output drill. You certify the noon dashboard. Its local definitions count items as "verified" only after an independent check and provide a separate "pending" field. Teams completed forty items; thirty-four passed checks, and six await checks scheduled for 1300. The dashboard accepts qualified entries and later updates, while the noon decision uses only the verified field.

### Response options

A. Enter forty as verified and use the dashboard note to identify six pending checks.  
B. Enter thirty-four verified and six pending, then update both fields after scheduled checks.  
C. Enter thirty-nine as verified from the prior pass rate, leaving the pending field empty.  
D. Leave both fields blank until every completed item receives its independent check.
...
C places an estimate in a field explicitly reserved for checked results and removes the available representation of uncertainty. Historical production figures do not decide this ranking; the local definitions and Chapter 1 accurate-reporting and transparency standards do. Those behavioral standards make C least effective.
...
**Primary concepts:** Production/readiness reporting; honesty; transparency; mission stewardship  
**ADTC context:** 2C, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human reporting-process review; the metric definitions are scenario facts, not current Air Force procedure
...
**ADTC context:** 2C, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human joint-editorial review; the stated exhibit roles are invented instructional constraints

---

## C02-SJT-009 — Teaching an emerging space capability

You design an unclassified tabletop lesson on civil reliance upon space-enabled services. A public announcement describes an emerging capability with projected performance, but its independent demonstration occurs next month. The lesson's validated baseline already meets every objective. The design standard permits hypothetical branches when clearly labeled; calculations shown to learners must identify their assumptions. You control lesson content and must publish this week.
...
D marks the conclusions as provisional but leaves learners unable to see that projected performance drives the calculations, contrary to the supplied design standard. Chapter 2's history of rapid capability development does not validate the projection. Chapter 1 honesty, accountability, and transparent treatment of uncertainty provide the behavioral basis for the least-effective judgment.
...
**ADTC context:** 2D, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human space-education review; no current, classified, or operational capability judgment is intended

---

## C02-SJT-010 — One name for two audiences

You coordinate public information for an unclassified annual logistics-recovery exercise with municipal responders. The naming panel must recommend one two-word name for commander approval and consistent internal and public use. Its brief calls for a name tied to recovery, understandable to partner audiences, and durable across annual repeats. Partner feedback understands "Hometown Lift"; internal planners prefer the energy of "Steel Strike," which partners interpret as combat-focused. You chair the panel's final recommendation.
...
B deliberately creates two simultaneous identities despite the stated requirement for consistent internal and public use. Chapter 2 explains why names can matter to audiences, but Chapter 1 honest communication, discipline, and consideration of downstream confusion provide the behavioral basis for the least-effective judgment.

### Option analysis

- **A — Partially effective:** It maintains one name but requires every public message to repair a known audience mismatch.
- **B — Least effective:** It solves preference differences by creating inconsistent identities and predictable coordination confusion.
- **C — Ineffective:** It preserves one-name consistency but abandons available findings for an untested appeal to fashion.
- **D — Most effective:** It recommends the finalist already understood by the affected audiences and supports accountable approval.

**Source basis:** AFH 1, ¶2.1 (historical context); ¶¶1.3.1, 1.3.3, 1.4.1 (behavioral basis)  
**Primary concepts:** Operation naming; public communication; accountability; teamwork; downstream effects  
**ADTC context:** 2A, A—Remembering  
**Ranks:** SSgt; TSgt  
**Review flag:** Human public-communication review; actual naming and release authorities control real exercises

---

## SJT coverage and self-ranking matrix

| Scenario | Historical-context domain | Self-ranked most | Self-ranked least | Principal behavioral distinction |
|---|---|---:|---:|---|
| C02-SJT-001 | Source/version ambiguity | C | A | Apply the designated baseline transparently rather than manufacture agreement |
| C02-SJT-002 | Accurate historical briefing | A | C | Preserve a supported conclusion rather than trade accuracy for impact |
| C02-SJT-003 | Crediting underrecognized contributors | D | A | Give precise credit rather than retain a familiar principal misattribution |
| C02-SJT-004 | Maintenance/readiness lessons | B | D | Design for the stated sustained-readiness objective rather than remove its constraint |
...
- [x] Exactly 10 scenarios are present, with sequential IDs C02-SJT-001 through C02-SJT-010.
- [x] Every scenario is wholly original and has exactly four response options.
- [x] Every option contains 12–18 words, and options within each scenario use comparable detail.
- [x] Every option is analyzed, including both non-keyed alternatives.
- [x] A separate editorial self-ranking found one unique most-effective and one unique least-effective response per scenario.
- [x] Most-effective keys vary across A, B, C, and D; least-effective keys also vary across all four positions.
- [x] Each stem states the learner's role, authority, process boundary, and material decision facts.
